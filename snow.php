...
useroptions.content = [];
        ...
        {   title: "TH1000-500",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_th15_frz_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 120,
            increment:3,
        ...
        {   title: "TH1000-850",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_th18_frz_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 120,
            increment:3,
        ...
        {   title: "t850",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_temp850_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 120,
            increment:3,
        ...
        {   title: "t500",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_temp500_eastmed_t",
            extension: ".png",
            minval: 6,
            maxval: 120,
            increment:3,
