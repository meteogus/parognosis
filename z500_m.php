...
<button class="button"  onclick="location.href='https://meteogus.github.io/parognosis/GFS_EM_panel_m.php'" type="button">Maps</button>
<button class="button"  onclick="location.href='https://meteogus.github.io/parognosis/z500_m.php'" type="button">500</button>
<button class="button"  onclick="location.href='https://meteogus.github.io/parognosis/t850_m.php'" type="button">850</button>
...
document.getElementById("plot1").src = "https://modeles16.meteociel.fr/modeles/gfs/run/gfs-0-"+nums[0]+".png";

document.getElementById("plot2").src = "https://www.meteociel.fr/modeles/ecmwf/run/ECM1-"+nums[1]+".GIF";

document.getElementById("plot3").src = "https://modeles3.meteociel.fr/modeles/ecmwfaifsv1/run/ecmwf-0-"+nums[2]+".png";

document.getElementById("plot4").src = "https://www.meteociel.fr/modeles/ecmwf/run/EDM1-"+nums[3]+".GIF";
}
