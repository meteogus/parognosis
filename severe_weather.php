...
document.getElementById("plot1").src = "https://stratus.meteo.noa.gr/forecast/HAIL/BOLAM_HSI_GR_"+num+".png";
document.getElementById("plot2").src = "https://stratus.meteo.noa.gr/forecast/HAIL/ICON_HSI_GR_"+num+".png";
document.getElementById("plot3").src = "https://stratus.meteo.noa.gr/data/gfs/GFS_severe_index_GR_t"+num+".png";
document.getElementById("plot4").src = "https://stratus.meteo.noa.gr/data/gfs/GFS_tornado_GR_t"+num+".png";
}
