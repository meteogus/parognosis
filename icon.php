...
useroptions.content = [];
        ...
        {   title: "ICON 00z",
            ...
            prefix : "https://www.wetterzentrale.de/maps/ICOOPIT00_",
            extension: "_4.png",
            minval: 3,
            maxval: 72,
            increment:3,
        ...
        {   title: "ICON 06z",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://www.wetterzentrale.de/maps/ICOOPIT06_",
            extension: "_4.png",
            minval: 3,
            maxval: 72,
            increment:3,
        ...
        {   title: "ICON 12z",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://www.wetterzentrale.de/maps/ICOOPIT12_",
            extension: "_4.png",
            minval: 3,
            maxval: 72,
            increment:3,
        ...
        {   title: "ICON 18z",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://www.wetterzentrale.de/maps/ICOOPIT18_",
            extension: "_4.png",
            minval: 3,
            maxval: 72,
            increment:3,
