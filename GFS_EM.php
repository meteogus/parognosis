...
useroptions.content = [];  
        ...
        {   title: "Low level convergence",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(6,96,3) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_convergence_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 45,
            increment:3,
        ...
        {   title: "RH500",
            ...
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_RH500_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
        ...
        {   title: "Mixing Ratio",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(72,120,24) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_mixing_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
