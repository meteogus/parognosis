...
<html><head><title>Precipitation-Meteo.GR</title>
...
useroptions.content = [];
        ...
        {   title: "BOLAM (storms)",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/forecast/HAIL/LIGHTNING/BOLAM_GR_PRECIP_LIG_",
            extension: ".png",
            minval: 3,
            maxval: 96,
            increment:3,
        ...
        {   title: "Hail",
            ...
            prefix : "https://stratus.meteo.noa.gr/forecast/HAIL/BOLAM_HSI_GR_",
            extension: ".png",
            minval: 3,
            maxval: 48,
            increment:3,
