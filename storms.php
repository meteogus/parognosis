...
useroptions.content = [];
        ...
        {   title: "Thunderstorm probability",
            ...
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_EL_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 60,
            increment:3,
        ...
        {   title: "MLCAPE (day)",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_mlcape_shear06_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
        ...
        {   title: "MUCAPE (night)",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_mucape_mucin_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
        ...
        {   title: "SREH 0-3km",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_sreh_eastmed_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
        ...
        {   title: "Severe storms",
            ...
            prefix : "https://stratus.meteo.noa.gr/data/gfs/GFS_severe_index_GR_t",
            extension: ".png",
            minval: 6,
            maxval: 96,
            increment:3,
