...
<html><head><title>BOLAM West</title>
...
useroptions.content = [];
        ...
        {   title: "3-hr Rain Snow",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,72,3) ,
            prefix : "https://stratus.meteo.noa.gr/forecast/BOLAM2020/f_RR_SN_io_",
            extension: ".png",
            minval: 3,
            maxval: 120,
            increment:3,
        ...
        {   title: "Wind 10m",
            ...
            prefix : "https://stratus.meteo.noa.gr/forecast/BOLAM2020/f_wind10_io_",
            extension: ".png",
            minval: 3,
            maxval: 120,
            increment:3,
