...
<button class="button"  onclick="ShiftPlot(+3)">t+3</button>
<button class="button"  onclick="ShiftPlot(+24)">t+24</button>
<button class="button"  onclick="location.href='https://github.com/meteogus/parognosis/BOLAM_GR.php'" type="button">Home</button>
</div>
...
document.getElementById("plot2").src = plotURL+"GFS_AV500_eastmed_t"+num+".png";
document.getElementById("plot3").src = plotURL+"GFS_RelVOR500-OMEGA_t"+num+".png";

document.getElementById("plot4").src = plotURL+"GFS_PW_GR_t"+num+".png";
document.getElementById("plot5").src = plotURL+"GFS_thetae_eastmed_t"+num+".png";
document.getElementById("plot6").src = plotURL+"GFS_mucape_mucin_GR_t"+num+".png";

document.getElementById("plot7").src = plotURL+"GFS_RH850_GR_t"+num+".png";
document.getElementById("plot8").src = plotURL+"GFS_RH700_GR_t"+num+".png";
document.getElementById("plot9").src = plotURL+"GFS_IVT_t"+num+".png";

document.getElementById("plot10").src = plotURL+"GFS_slp_gp500_eastmed_t"+num+".png";
document.getElementById("plot11").src = plotURL+"GFS_temp500_eastmed_t"+num+".png";
document.getElementById("plot12").src = plotURL+"GFS_temp850_eastmed_t"+num+".png";
