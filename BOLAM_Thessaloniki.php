...
<html><head><title>BOLAM Salonica</title>
...
useroptions.content = [];
        ...
        {   title: "3-hr Snow-Rain",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/forecast/BOLAM2020/f_RR_SN_skg_",
            extension: ".png",
            minval: 3,
            maxval: 120,
            increment:3,
        ...
        {   title: "Wind 10m",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://stratus.meteo.noa.gr/forecast/BOLAM2020/f_wind10_skg_",
            extension: ".png",
            minval: 3,
            maxval: 120,
            increment:3,
