...
useroptions.content = [];
        ...
        {   title: "UKMO",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,24) ,
            prefix : "https://modeles14.meteociel.fr/modeles/ukmo/run/ukmo-1-",
            extension: ".png",
            minval: 12,
            maxval: 168,
            increment:12,
        ...
        {   title: "ECMWF (<120)",
            ...
            prefix : "https://modeles3.meteociel.fr/modeles/ecmwf2/run/ecmwf-1-",
            extension: ".png",
            minval: 12,
            maxval: 240,
            increment:12,
        ...
        {   title: "GEM",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://modeles16.meteociel.fr/modeles/gemgdps/run/gemgdps-1-",
            extension: ".png",
            minval: 12,
            maxval: 240,
            increment:12,
        ...
        {   title: "ECMWF-AVG (>120)",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://modeles3.meteociel.fr/modeles/gens/ecmwf/run/gens-51-0-",
            extension: ".png",
            minval: 12,
            maxval: 240,
            increment:12,
        ...
        {   title: "AIFS (192-240)",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://modeles3.meteociel.fr/modeles/ecmwfaifsv1/run/ecmwf-1-",
            extension: ".png",
            minval: 12,
            maxval: 240,
            increment:12,
        ...
        {   title: "GFS AVG",
            startingframe: 0,
                    label_interval: 1,
                    labels : fspan(0,156,12) ,
            prefix : "https://modeles16.meteociel.fr/modeles/gens/run/gens-31-0-",
            extension: ".png",
            minval: 12,
            maxval: 240,
            increment:12,
